  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        <MetricBlock label="Faithfulness" value="0.94" tone="success" />
        <MetricBlock label="Context recall" value="0.89" tone="success" />
        <MetricBlock label="Trials run" value="24" />
        <MetricBlock label="P95 latency" value="640ms" />
      </div>
